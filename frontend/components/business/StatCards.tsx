  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
      <div className="bg-[var(--bg-elevated)] rounded-none p-4 text-center">
        <div className="text-3xl font-bold text-[var(--accent)] font-[family-name:var(--font-mono)]">
          {stats.total_reviews}
        </div>
      ...
      <div className="bg-[var(--bg-elevated)] rounded-none p-4 text-center">
        <div className="text-3xl font-bold text-[var(--positive)] font-[family-name:var(--font-mono)]">
      ...
      <div className="bg-[var(--bg-elevated)] rounded-none p-4 text-center">
        <div className="text-3xl font-bold text-[var(--negative)] font-[family-name:var(--font-mono)]">
