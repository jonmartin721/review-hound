...
export function BusinessGrid({ businesses, onEdit, onDelete, onAddBusiness }: BusinessGridProps) {
  if (businesses.length === 0) {
    return (
      <div className="bg-[var(--bg-surface)] rounded-xl shadow-sm border border-[var(--border)] p-12 text-center">
        <div className="mx-auto w-16 h-16 bg-[var(--bg-muted)] rounded-full flex items-center justify-center mb-4">
        ...
        {onAddBusiness && (
          <button
            ...
            className="mt-6 bg-indigo-600 text-white px-5 py-2.5 rounded-lg hover:bg-indigo-700 transition font-medium inline-flex items-center gap-2"
          >
