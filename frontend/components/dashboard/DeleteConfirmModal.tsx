  ...
  return (
    <Modal isOpen onClose={onClose} title="">
      <div className="flex items-center mb-4 -mt-5">
        <div className="w-10 h-10 bg-[var(--negative)]/10 rounded-none flex items-center justify-center mr-3 flex-shrink-0">
          <svg className="w-5 h-5 text-[var(--negative)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
